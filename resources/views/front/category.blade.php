        ...
        <main class="relative flex flex-col w-full gap-[30px] mt-[30px] overflow-x-hidden">
            <div class="flex flex-col gap-2 px-4">
                <div class="flex items-center gap-[6px]">
                    <img src="{{Storage::url($category->icon)}}" class="w-[22px] h-[22px]" alt="icon">
                    <p class="font-semibold text-sm leading-[21px] text-white"></p>
                </div>
                    ...
                    <div class="flex items-center justify-between rounded-3xl p-[6px] pr-[14px] bg-white overflow-hidden">
                        <div class="flex items-center gap-[14px]">
                            <div class="flex w-[90px] h-[90px] shrink-0 rounded-3xl bg-[#D9D9D9] overflow-hidden">
                                <img src="((Storage::url($itemTicket->thumbnail)}}" class="w-full h-full object-cover" alt="thumbnail">
                            </div>
                            <div class="flex flex-col gap-[6px]">
                                ...
                                <p class="font-bold text-sm leading-[21px] text-[#F97316]">
                                    Rp {{number_format($itemTicket->price, 0, '.', ',')}}
                                </p>
                            </div>
                        </div>
