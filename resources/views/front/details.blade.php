...
<body>
    <div class="relative flex flex-col w-full min-h-screen max-w-[640px] mx-auto bg-white">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="relative flex items-center w-full h-[480px] shrink-0 bg-[#13181D] overflow-hidden">
                            ...
                            <div class="plyr__video-embed/{{$ticket->path_video}}" id="player" style="width: 100%; height: 100%;">
                                <iframe
                                    src="https://www.youtube.com/watch?v=d7T1R-RvoXw"
                                    allowfullscreen
                                    allowtransparency
                                    allow="autoplay"
                                ></iframe>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex items-center rounded-3xl p-[14px_16px] gap-4 bg-[#F8F8F9]">
                        ...
                        <div class="text-left">
                            ...
                            <p class="font-bold text-lg leading-[27px]">{{$ticket->open_time}}</p>
                        </div>
                    </div>
                    <div class="flex items-center rounded-3xl p-[14px_16px] gap-4 bg-[#F8F8F9]">
                        ...
                        <div class="text-left">
                            ...
                            <p class="font-bold text-lg leading-[27px]">{{$ticket->close_time}}</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="flex items-center justify-between rounded-3xl p-[10px] pr-[14px] bg-[#F8F8F9]">
                    <div class="flex items-center gap-[14px]">
                        ...
                        <div>
                            ...
                            <p class="text-sm leading-[21px]">{{$ticket->seller->count()}} Places</p>
                        </div>
                    </div>
                    <a href="#">
        ...
        <nav id="Bottom-Nav-Book" class="fixed bottom-0 flex items-center justify-between w-full max-w-[640px] bg-white p-4 z-30">
            <div>
                <p class="font-bold text-[22px] leading-[26px]">Rp {{$ticket->price}}</p>
